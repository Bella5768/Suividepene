"""
Django settings for suivi_depense project.
"""
...
if not SECRET_KEY:
    ...
    import warnings
    warnings.warn(
        "SECRET_KEY not configured in environment. Using randomly generated key. "
...
MIDDLEWARE = [
    ...
    'suivi_depense.cors_middleware.CORSMiddleware',
...
ROOT_URLCONF = 'suivi_depense.urls'
...
WSGI_APPLICATION = 'suivi_depense.wsgi.application'
...
if USE_SQLITE:
    ...
    DATABASES = {
        'default': {
            ...
            'NAME': config('DB_NAME', default='suivi_depense'),
...
# Frontend vanilla files location
STATICFILES_DIRS = [
    BASE_DIR / 'depenses' / 'static' / 'depenses',
]

MEDIA_URL = '/media/'
MEDIA_ROOT = BASE_DIR / 'media'

# Templates configuration for serving frontend
TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [BASE_DIR / 'depenses' / 'templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
                'django.template.context_processors.debug',
